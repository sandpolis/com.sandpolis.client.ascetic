...
//                                                                            //
//============================================================================//
package com.sandpolis.client.ascetic.view.generator;
	...
	public GeneratorWindow() {
...

		{
			...
			Button btn_generate = new Button("Generate", () -> {
				...
				var config = AgentConfig.newBuilder().setLoopConfig(LoopConfig.newBuilder().setTimeout(5000)
						.setCooldown(Integer.parseInt(fld_timeout.getText())).addTarget(NetworkTarget.newBuilder()
								.setAddress(fld_address.getText()).setPort(Integer.parseInt(fld_port.getText()))));
